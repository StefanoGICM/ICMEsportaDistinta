...
/****** Object:  Table [dbo].[XPORT_ANAG]    Script Date: 12/13/2022 8:26:38 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[XPORT_ANAG](
 ...
 CONSTRAINT [PK_XPORT_ANAG] PRIMARY KEY CLUSTERED 
(
	[DEDID] ASC,
	[DEDREV] ASC
...
ALTER TABLE [dbo].[XPORT_ANAG] ADD  CONSTRAINT [DF_XPORT_ANAG_DEDStart]  DEFAULT ('N') FOR [DEDStart]
GO

CREATE INDEX IX_XPORT_ANAG_DEDStart ON [dbo].[XPORT_ANAG] ([DEDStart]);
GO